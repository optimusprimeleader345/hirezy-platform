          ...
          {showProfileDropdown && (
            <div className="absolute top-full right-0 mt-2 w-48 glass-card border border-white/20 rounded-lg py-2 z-50">
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-white/70 hover:bg-white/5 hover:text-white flex items-center"
              >
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-white/70 hover:bg-red-500/20 hover:text-red-400 flex items-center"
              >

              ...
              <AdminGlassCard title="Role Distribution">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold">{analytics.distribution.roles.student}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <UserCheck className="w-5 h-5 text-blue-400" />
                    <span className="flex-1">Recruiters</span>
                    <span className="font-bold">{analytics.distribution.roles.recruiter}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Crown className="w-5 h-5 text-purple-400" />
                    <span className="flex-1">Admins</span>
                    <span className="font-bold">{analytics.distribution.roles.admin}</span>
                  </div>
                </div>
              </AdminGlassCard>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            {user.verified && <CheckCircle className="w-4 h-4 text-green-400" title="Verified" />}
                            {user.warnings > 0 && (

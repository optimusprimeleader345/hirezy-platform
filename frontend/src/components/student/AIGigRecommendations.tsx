...
import { defaultRecommendations } from '@/lib/studentMockData'
  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      try {
        ...
        console.warn('Using demo recommendations:', err)
        setRecommendations(defaultRecommendations.recommendations)
      } finally {
        setLoading(false)
      }
    }
